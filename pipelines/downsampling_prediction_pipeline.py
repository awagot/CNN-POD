...
def generate_downsampling_prediction_pipeline(tfr_path, channels, n_modes, downsample_value, validation_split=0.2, batch_size=8, shuffle_buffer=400, n_prefetch=4, cpu=False):
